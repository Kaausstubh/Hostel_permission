...
*   Install [MongoDB](https://www.mongodb.com/) (locally or use MongoDB Atlas free tier)
*   Install [Redis](https://redis.io/) (locally or use Upstash free tier)
...
```
Access the frontend on [http://localhost:5173](http://localhost:5173) and backend API on [http://localhost:5000](http://localhost:5000).
...
*   📘 **[DEPLOYMENT.md](file:///Users/kaustubh/Desktop/Hostel_permission-main/DEPLOYMENT.md)**: Deployment steps for Render (API) and Vercel (Frontend).
*   📋 **[GO_LIVE_CHECKLIST.md](file:///Users/kaustubh/Desktop/Hostel_permission-main/GO_LIVE_CHECKLIST.md)**: Production SLOs and performance targets to satisfy.
*   🏁 **[STAGED_ROLLOUT.md](file:///Users/kaustubh/Desktop/Hostel_permission-main/STAGED_ROLLOUT.md)**: Safe rollout strategies, monitoring, and failover runbooks.
